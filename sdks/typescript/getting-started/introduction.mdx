...
1. **Product & Plan Setup**: In onboarding, create your first product and configure plans in the same flow
...
4. **Payment Processing**: After first product creation, complete Stripe setup in the console (handled by SolvaPay backend)
...
- [Core Concepts](./core-concepts.mdx) - Understand products, plans, and the paywall flow
