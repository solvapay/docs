...
description: "This document provides an overview of all available examples in the SolvaPay SDK repository."
---
...
3. **SolvaPay Account** (for examples with real backend)
   - Sign up at https://app.solvapay.com
...
- [Quick Start Guide](../getting-started/quick-start.mdx)
- [Core Concepts](../getting-started/core-concepts.mdx)

### Framework Guides

- [Express.js Integration](../guides/express.mdx)
- [Next.js Integration](../guides/nextjs.mdx)
- [React Integration](../guides/react.mdx)
- [MCP Server Integration](../guides/mcp.mdx)

### Advanced Topics

- [Custom Authentication Adapters](../guides/custom-auth.mdx)
- [Error Handling](../guides/error-handling.mdx)
- [Testing with Stub Mode](../guides/testing.mdx)
- [Performance Optimization](../guides/performance.mdx)
- [Webhook Handling](../guides/webhooks.mdx)

### API Reference

- [Server SDK API Reference](/sdks/typescript/intro)
- [React SDK API Reference](/sdks/typescript/intro)
- [Next.js SDK API Reference](/sdks/typescript/intro)
