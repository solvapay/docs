...
3. [SDK Installation](/sdks/typescript/setup/installation) - Add SolvaPay to your project
4. [SDK Quick Start](/sdks/typescript/setup/quick-start) - Protect your first endpoint
