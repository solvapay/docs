...
2. **[Create a product](./create-product)** - Configure product and plans in Console
3. **[Test in sandbox](./test-in-sandbox)** - Validate auth, checkout, and access control
4. **[Go live](./go-live)** - Switch to production when ready
