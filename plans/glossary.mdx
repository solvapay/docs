...
Overage is usage beyond the included allowance, charged per meter noun and paid from prepaid credits. A plan with no included cap pays for every counted item from credits at the per-request rate.
