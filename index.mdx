...
description: "Documentation for adding authentication, identity, payments, and billing with the no-code MCP integration or the TypeScript SDK."
mode: "wide"
---
...
<Columns cols={2}>
  <Card
    title="No-code MCP auth and monetization"
    icon="credit-card"
