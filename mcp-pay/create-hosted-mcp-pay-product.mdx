...
_Screenshot placeholder: plans step with selected plans in new product flow._
...
_Screenshot placeholder: integration step with Hosted MCP Pay URL fields._
...
_Screenshot placeholder: Hosted MCP product details page with MCP server URL._
