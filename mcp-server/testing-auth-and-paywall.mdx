...
Use this guide to validate your MCP Server in **production** after setup. This flow is shared across
the managed path and SDK integration.

## Prerequisites

Before testing, make sure you have:

- An active product with Managed MCP or SDK paywall configuration complete
...
- Confirm you are testing in **production** with production credentials
