...
Regularly review the no-code MCP dashboard to:
...
The no-code MCP dashboard shows transaction history, usage statistics, and revenue metrics. You can also view per-product stats from the product detail page.
