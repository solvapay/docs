---
title: "Hosted pages"
description: "Managed MCP provides fully hosted pages for the complete customer journey—sign-up, checkout, and account management."
---
...
Configure these in **Settings > Hosted pages**:
...
Add your **Terms of Service URL** and **Privacy Policy URL** in **Settings > Hosted pages**. Hosted checkout, sign-in, and OAuth consent then link those documents in the consent sentence, followed by SolvaPay's own terms. SolvaPay links also stay in the page footer. Leave either field empty to omit that merchant document from the sentence.
...
Managed MCP injects these tools into every server for purchase management:
