...
description: "TypeScript packages for monetizing APIs, AI agents, and MCP (Model Context Protocol) servers with paywall protection and purchase management."
---

Monetize APIs, AI apps, and MCP servers with one type-safe API.
Protect endpoints with paywalls, verify purchases, and run checkout flows from one integration.
