...
> **Prefer a one-command setup?** Run `npx solvapay init` to authenticate, configure
> environment variables, and install packages automatically. See [CLI Setup](./cli).
...
See [Express.js Integration Guide](../guides/express.mdx) for detailed setup.
...
See [Next.js Integration Guide](../guides/nextjs.mdx) for detailed setup.
...
See [React Integration Guide](../guides/react.mdx) for detailed setup.
...
See [MCP Server Integration Guide](../guides/mcp.mdx) for detailed setup.

## Next Steps

- [Quick Start Guide](./quick-start.mdx) - Get up and running in 5 minutes
- [Core Concepts](./core-concepts.mdx) - Understand the key concepts
- [Framework Guides](../guides/express.mdx) - Framework-specific integration guides
