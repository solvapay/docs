---
title: "Architecture"
description: "Goal: Clean runtime boundaries, great DX, and focused packages."
---
...
- Version independently with Changesets, or keep in lockstep early on.
...
See [testing guide](./testing.mdx) for comprehensive test examples.
