...
- [Next.js Integration Guide](./nextjs.mdx) - Learn Next.js-specific integration
- [Custom Authentication Adapters](./custom-auth.mdx) - Build custom auth adapters
- [Error Handling Strategies](./error-handling.mdx) - Advanced error handling
