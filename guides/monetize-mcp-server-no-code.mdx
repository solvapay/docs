...
description: "Use MCP Pay to monetize your MCP server without changing server code."
---
...
By the end, your MCP server is available through MCP Pay, with plans and checkout flows ready for
customers.
...
- Confirm this is the right path in [MCP Pay overview](/mcp-pay/overview).
- Follow [MCP Pay quick start](/mcp-pay/quick-start).
- Complete [Create a Hosted MCP Pay Product](/mcp-pay/create-hosted-mcp-pay-product).
- Configure [authentication](/mcp-pay/authentication) and verify client connection.
- Review [hosted pages](/mcp-pay/hosted-pages) to style checkout and account pages for your brand.
