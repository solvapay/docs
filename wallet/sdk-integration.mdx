...
Product-based access with usage quotas. No token locking — the SDK checks if the consumer's purchase allows the request and tracks usage. Plans are resolved automatically from the customer's purchase.
