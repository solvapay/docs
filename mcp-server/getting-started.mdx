...
## Admin MCP Server vs Managed MCP
...
The [Managed MCP](/no-code-mcp/overview) path is a separate product type for managed auth and monetization of your own MCP servers.
