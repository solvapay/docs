...
// event.type is typed as WebhookEventType — autocomplete for all 12 event names
...
| Event | Trigger | Description |
|---|---|---|
| `customer.created` | Customer created via API or checkout | A new customer record has been created. |
