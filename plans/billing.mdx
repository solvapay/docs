...
| `limit.onExceed` | `block` stops access and offers the product's other plans at checkout; `charge` bills overage on the saved card at period end; `top_up` draws prepaid credits past the cap |
