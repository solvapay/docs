...
description: "SolvaPay offers two ways to monetize your services. This guide helps you pick the right approach."
---

## Decide in 10 Seconds[​](#decide-in-10-seconds "Direct link to Decide in 10 Seconds")
...
## Hosted MCP Pay (No-Code)[​](#hosted-mcp-pay-no-code "Direct link to Hosted MCP Pay (No-Code)")
...
### Choose MCP Pay If You:[​](#choose-mcp-pay-if-you "Direct link to Choose MCP Pay If You:")
...
3. [Create a Hosted MCP Pay Product](/mcp-pay/create-hosted-mcp-pay-product) - No-code hosted MCP setup
...
### Choose SDK If You:[​](#choose-sdk-if-you "Direct link to Choose SDK If You:")
...
## Can I Use Both?[​](#can-i-use-both "Direct link to Can I Use Both?")
