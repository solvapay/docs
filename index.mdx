...
description: "Documentation for adding authentication, identity, payments, and billing with Managed MCP or the TypeScript SDK."
mode: "wide"
---
...
<div id="welcome-home" style={{ margin: '2rem auto 2.5rem auto', maxWidth: '980px' }}>
  ...
  >
    ...
    >
      Choose Managed MCP for hosted flows, or use the TypeScript SDK for code-level integration.
    </p>
  </div>
</div>
...
<Columns cols={2}>
  <Card
    title="Managed MCP auth and monetization"
    icon="credit-card"
  ...
  <Card title="TypeScript SDK" icon="code" href="/sdks/typescript/setup/cli">
    Run `npx solvapay@latest init` to connect your project and start SDK integration in minutes.
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="Use the SolvaPay agent skill" icon="sparkles" href="/guides/use-agent-skill">
    Start with one command: `npx skills add solvapay/skills`. Use platform-specific setup only if needed.
  </Card>
</Columns>
