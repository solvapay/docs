...
1. **Product & Plan Setup**: Create your product in the SolvaPay UI and configure plans in the same flow. Products are available for SDK integration by default.
...
4. **Payment Processing**: After first product creation, complete Stripe setup for payment processing (handled by SolvaPay backend)
...
- **[Installation Guide](./getting-started/installation.mdx)** - Set up SolvaPay SDK in your project
- **[Quick Start](./getting-started/quick-start.mdx)** - Get up and running in 5 minutes
...
- **[Architecture Guide](./guides/architecture.mdx)** - Detailed technical architecture and package design
- **[Examples](./examples/overview.mdx)** - Working examples and demos
...
**Ready to get started?** Check out the [Installation Guide](./getting-started/installation.mdx) or jump straight to the [Quick Start](./getting-started/quick-start.mdx)!
