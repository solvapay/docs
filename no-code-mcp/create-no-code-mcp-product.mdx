---
title: "Create a Managed MCP product"
description: "Use this flow when you want the managed path: SolvaPay hosts authentication, identity, billing, and payment. No code required."
---
...
## Step 2: Enable Managed MCP

In the Integration step, enable and configure Managed MCP:
