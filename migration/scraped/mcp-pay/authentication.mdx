...
## Supported Authentication Providers[​](#supported-authentication-providers "Direct link to Supported Authentication Providers")
...
## How MCP Client Authentication Works[​](#how-mcp-client-authentication-works "Direct link to How MCP Client Authentication Works")

When a user adds your MCP server to their client (e.g., Cursor), the following OAuth flow occurs:

```
┌──────────────┐     ┌─────────────────┐     ┌──────────────────┐│  MCP Client  │────▶│  SolvaPay OAuth │────▶│  Google/GitHub   ││  (Cursor)    │     │  Server         │     │  Login           │└──────────────┘     └─────────────────┘     └──────────────────┘       │                     │                        │       │  1. Authorize       │                        │       │─────────────────────▶                        │       │                     │  2. Redirect to login  │       │                     │────────────────────────▶       │                     │                        │       │                     │  3. User authenticates │       │                     │◀────────────────────────       │                     │                        │       │  4. Auth code       │                        │       │◀─────────────────────                        │       │                     │                        │       │  5. Exchange token  │                        │       │─────────────────────▶                        │       │                     │                        │       │  6. Access token    │                        │       │◀─────────────────────                        │
```

### Flow Steps[​](#flow-steps "Direct link to Flow Steps")
...
## Dynamic Client Registration (DCR)[​](#dynamic-client-registration-dcr "Direct link to Dynamic Client Registration (DCR)")
...
### How DCR Works[​](#how-dcr-works "Direct link to How DCR Works")
...
### Benefits of DCR[​](#benefits-of-dcr "Direct link to Benefits of DCR")
...
## Hosted Login Page[​](#hosted-login-page "Direct link to Hosted Login Page")
...
### First-Time Users[​](#first-time-users "Direct link to First-Time Users")
...
## OAuth Scopes[​](#oauth-scopes "Direct link to OAuth Scopes")
...
## Custom Protocol Support[​](#custom-protocol-support "Direct link to Custom Protocol Support")
...
### Refresh Tokens[​](#refresh-tokens "Direct link to Refresh Tokens")
...
### PKCE (Proof Key for Code Exchange)[​](#pkce-proof-key-for-code-exchange "Direct link to PKCE (Proof Key for Code Exchange)")
...
### Token Storage[​](#token-storage "Direct link to Token Storage")
...
### Authentication Fails[​](#authentication-fails "Direct link to Authentication Fails")
...
### Token Expired[​](#token-expired "Direct link to Token Expired")
...
### DCR Not Working[​](#dcr-not-working "Direct link to DCR Not Working")
